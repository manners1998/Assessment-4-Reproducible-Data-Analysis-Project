...
The total cost of the starting line up is \$62,057,547 leaving a remaining budget of \$55,942,453 for the bench players. With there being 10 bench players the average cost for each player being approximately \$5,594,245. The limitation of the data is only focusing on a set number of statistics for each position. Another limitation is that all players where based on averages so a future project would break down the stats further.  
