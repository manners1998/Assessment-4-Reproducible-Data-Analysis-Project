...
salaries <- read.csv("data/raw-data/2018-19_nba_player-salaries.csv")
statistics <- read.csv("data/raw-data/2018-19_nba_player-statistics.csv")
team_statistics_1 <- read_csv("data/raw-data/2018-19_nba_team-statistics_1.csv")
team_statistics_2 <- read_csv("data/raw-data/2018-19_nba_team-statistics_2.csv")
payroll <- read.csv("data/raw-data/2019-20_nba_team-payroll.csv")
